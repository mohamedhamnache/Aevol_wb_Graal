...
var NbBlockScrollStrategyAdapter = /** @class */ (function (_super) {
    ...
    NbBlockScrollStrategyAdapter = __decorate$21([
        i0.Injectable(),
        __param$8(1, i0.Inject(NB_DOCUMENT)),
        __metadata$13("design:paramtypes", [NbViewportRulerAdapter, Object])
...
var NbHoverTriggerStrategy = /** @class */ (function (_super) {
    ...
    function NbHoverTriggerStrategy() {
        ...
        _this.show$ = rxjs.fromEvent(_this.host, 'mouseenter')
            .pipe(rxjs_operators.filter(function () { return !_this.container(); }), rxjs_operators.delay(100), rxjs_operators.takeUntil(rxjs.fromEvent(_this.host, 'mouseleave')), rxjs_operators.repeat());
